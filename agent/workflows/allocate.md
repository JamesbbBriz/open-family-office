...
4. Run `python scripts/ofo.py compare-allocation <household.json> <policy.json>`.
...
This workflow remains user-confirmed policy comparison. Separate `ofo-optimize` and `ofo-simulate` workflows support research using explicit liquid-sleeve inputs; do not conflate their outputs with suitable household allocations.
